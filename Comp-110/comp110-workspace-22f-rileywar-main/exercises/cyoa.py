...
def feed(amount: list[int]) -> int:
    """Feeds your krismon treats which equal the amount of adventure points."""
    if amount == 0: 
...
def greet() -> None:
    ...
    global player
    player = input(f"Welcome to Krismon! Krismon is a pokemon style fighting game.{SMILEY_FACE}\nWhat is your name? ")
    return (f"Have fun, {player}!")
